...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'collaborativeCreateHint': 'One photo per person — add your image now; contributors add theirs later. No carousel or music.',
    'collaborativeNoCarouselAudio': 'Collaborative posts cannot include multiple photos or music.',
    'collaborativeMediaCleared': 'Carousel and music removed — collaborative posts use one photo per person.',
  ...
  ar: {
    ...
    'collaborativeCreateHint': 'صورة واحدة لكل شخص — أضف صورتك الآن، ويضيف المساهمون صورهم لاحقاً. بدون عدة صور أو موسيقى.',
    'collaborativeNoCarouselAudio': 'المنشورات التعاونية لا تدعم عدة صور أو موسيقى.',
    'collaborativeMediaCleared': 'تمت إزالة الصور المتعددة والموسيقى — المنشور التعاوني يسمح بصورة واحدة لكل شخص.',
