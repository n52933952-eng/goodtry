...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'removeYourPhoto': 'Remove your photo',
    'removeYourPhotoQuestion': 'Remove your photo from this collaborative post?',
    'photoRemoved': 'Photo removed',
    'failedToRemovePhoto': 'Failed to remove photo',
    'collaborativePhotoHint': 'Each contributor can add one photo to this post.',
    'collaborativeEditTextHint': 'To change your photo, use “Change your photo” on the post.',
    'collaborativeCreateHint': 'One photo per person — add your image now; contributors add theirs later. As owner you can add optional music (MP3).',
    'collaborativeNoCarousel': 'Collaborative posts cannot include multiple photos.',
    'collaborativeMediaCleared': 'Multiple photos removed — collaborative posts use one photo per person.',
    'collaborativeOwnerMusicHint': 'Only you (the post owner) can add background music to this collaborative post.',
    'changeMusic': 'Change music',
    'removeMusic': 'Remove music',
    'musicRemoved': 'Music removed',
    'collaborativePhotoImagesOnly': 'Collaborative posts only support photos, not videos.',
    'photoAdded': 'Photo added',
    'failedToUploadPhoto': 'Failed to upload photo',
    'carouselPhotos': 'Carousel photos (up to 4)',
    'carouselPost': 'Carousel post',
    'carouselEditTextHint': 'Tap a photo to replace it. Use ✕ to remove or + to add (up to 4).',
    'carouselOwnerMusicHint': 'Add or replace background music for this carousel post.',
    'addMusic': 'Add music (MP3)',
    'musicAdded': 'Music added',
    'photos': 'photos',
    'carouselMaxPhotos': 'You can add up to 4 photos',
    'pickAudioFileHint': 'Open your Files or Music app and choose an MP3 or audio file.',
    'failedToPickAudio': 'Failed to pick audio',
    'video': 'Video',
    'editedPost': 'Edited',
    'showMore': 'Show more',
    'showLess': 'Show less',
    ...
    'galleryPhotosOnly': 'Gallery (photos only)',
    'carouselPhotosOnly': 'Carousel posts support photos only, not video.',
    'image': 'Image',
    ...
    'postVideoTooLongTitle': 'Video too long',
    'postVideoTooLongBody': 'Videos must be 10 minutes or less.',
    'postAudioTooLongTitle': 'Music too long',
    'postAudioTooLongBody': 'Music must be 4 minutes or less.',
    ...
    'capsuleOpenedText': 'Your reminder is ready. Tap to open the post.',
    'now': 'now',
    ...
    'selectMembersFromFollowing': 'Select members from your following list',
    'membersSelected': '{{count}} member{{suffix}} selected',
    'noFollowingUsers': 'No following users',
    'followPeopleToAddGroup': 'Follow people to add them to a group',
    ...
    'leaveGroupConfirm': 'Leave "{{name}}"? You will no longer receive messages.',
    'failedToLeaveGroup': 'Failed to leave group',
    'deleteGroup': 'Delete Group',
    'deleteGroupConfirm': 'Permanently delete "{{name}}" and all its messages? This cannot be undone.',
    ...
    'couldNotLoadFollowingList': 'Could not load your following list',
    'everyoneAlreadyInGroup': 'Everyone you follow is already in this group',
    'noOneToAddFromFollowing': 'No one to add from your following list',
    'groupDeletedTitle': 'Group Deleted',
    'groupDeletedByAdmin': 'This group has been deleted by the admin.',
  },
  ar: {
    // Login Screen
    ...
    'changeYourPhoto': 'غيّر صورتك',
    'removeYourPhoto': 'إزالة صورتك',
    'removeYourPhotoQuestion': 'إزالة صورتك من هذا المنشور التعاوني؟',
    'photoRemoved': 'تمت إزالة الصورة',
    'failedToRemovePhoto': 'فشل إزالة الصورة',
    'collaborativePhotoHint': 'يمكن لكل مساهم إضافة صورة واحدة لهذا المنشور.',
    'collaborativeEditTextHint': 'لتغيير صورتك، استخدم «غيّر صورتك» على المنشور.',
    'collaborativeCreateHint': 'صورة واحدة لكل شخص — أضف صورتك الآن، ويضيف المساهمون صورهم لاحقاً. كصاحب المنشور يمكنك إضافة موسيقى اختيارية (MP3).',
    'collaborativeNoCarousel': 'المنشورات التعاونية لا تدعم عدة صور.',
    'collaborativeMediaCleared': 'تمت إزالة الصور المتعددة — المنشور التعاوني يسمح بصورة واحدة لكل شخص.',
    'collaborativeOwnerMusicHint': 'أنت فقط (صاحب المنشور) يمكنك إضافة موسيقى خلفية لهذا المنشور التعاوني.',
    'changeMusic': 'تغيير الموسيقى',
    'removeMusic': 'إزالة الموسيقى',
    'musicRemoved': 'تمت إزالة الموسيقى',
    'collaborativePhotoImagesOnly': 'المنشورات التعاونية تدعم الصور فقط وليس الفيديو.',
    'photoAdded': 'تمت إضافة الصورة',
    'failedToUploadPhoto': 'فشل رفع الصورة',
    'carouselPhotos': 'صور متعددة (حتى 4)',
    'carouselPost': 'منشور متعدد الصور',
    'carouselEditTextHint': 'اضغط على الصورة لاستبدالها. استخدم ✕ للحذف أو + للإضافة (حتى 4).',
    'carouselOwnerMusicHint': 'أضف أو غيّر الموسيقى الخلفية لهذا المنشور.',
    'addMusic': 'إضافة موسيقى (MP3)',
    'musicAdded': 'تمت إضافة الموسيقى',
    'photos': 'صور',
    'carouselMaxPhotos': 'يمكنك إضافة حتى 4 صور',
    'pickAudioFileHint': 'افتح تطبيق الملفات أو الموسيقى واختر ملف MP3 أو صوت.',
    'failedToPickAudio': 'فشل اختيار الملف الصوتي',
    'video': 'فيديو',
    ...
    'galleryPhotosOnly': 'المعرض (صور فقط)',
    'carouselPhotosOnly': 'منشورات الكاروسيل تدعم الصور فقط وليس الفيديو.',
    'image': 'صورة',
    ...
    'postVideoTooLongTitle': 'الفيديو طويل جداً',
    'postVideoTooLongBody': 'يجب ألا تتجاوز مدة الفيديو 10 دقائق.',
    'postAudioTooLongTitle': 'الموسيقى طويلة جداً',
    'postAudioTooLongBody': 'يجب ألا تتجاوز الموسيقى 4 دقائق.',
    ...
    'capsuleOpenedText': 'تذكيرك جاهز الآن. اضغط لفتح المنشور.',
    'now': 'الآن',
    ...
    'selectMembersFromFollowing': 'اختر الأعضاء من قائمة متابعتك',
    'membersSelected': 'تم اختيار {{count}} عضو{{suffix}}',
    'noFollowingUsers': 'لا يوجد مستخدمون تتابعهم',
    'followPeopleToAddGroup': 'تابع أشخاصًا لإضافتهم إلى مجموعة',
    'pleaseEnterGroupName': 'يرجى إدخال اسم المجموعة',
    'selectAtLeastOneMember': 'اختر عضوًا واحدًا على الأقل',
    ...
    'alreadyIn': 'موجود بالفعل',
    'addMember': 'إضافة',
    'leaveGroup': 'مغادرة المجموعة',
    'leaveGroupConfirm': 'مغادرة "{{name}}"؟ لن تصلك رسائل هذه المجموعة بعد الآن.',
    'failedToLeaveGroup': 'فشل مغادرة المجموعة',
    'deleteGroup': 'حذف المجموعة',
    'deleteGroupConfirm': 'حذف "{{name}}" وجميع رسائلها نهائيًا؟ لا يمكن التراجع عن هذا.',
    'failedToDeleteGroup': 'فشل حذف المجموعة',
    'removeMember': 'إزالة عضو',
    'removeMemberConfirm': 'إزالة {{name}} من المجموعة؟',
    'failedToRemoveMember': 'فشل إزالة العضو',
    'couldNotLoadFollowingList': 'تعذر تحميل قائمة المتابعة',
    'everyoneAlreadyInGroup': 'كل من تتابعهم موجودون بالفعل في هذه المجموعة',
    'noOneToAddFromFollowing': 'لا يوجد أحد لإضافته من قائمة متابعتك',
    'groupDeletedTitle': 'تم حذف المجموعة',
    'groupDeletedByAdmin': 'تم حذف هذه المجموعة بواسطة المشرف.',
  },
};
